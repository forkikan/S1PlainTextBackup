...
if __name__ == '__main__':
    ...
    #     print(subject)
    #     #url为要回帖的地址
    #     Data = {'formhash': formhash,'message': 回帖字符串,'subject': subject,'posttime':int(time.time()),'addfeed':'1', 'allownoticeauthor':'1', 'checkbox':'0', 'newalbum':'', 'readperm':'', 'rewardfloor':'', 'rushreplyfrom':'', 'rushreplyto':'', 'save':'', 'stopfloor':'', 'typeid':'', 'uploadalbum':'', 'usesig':'1', 'wysiwyg':'0'}
